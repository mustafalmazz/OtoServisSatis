...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public  async Task<ActionResult> CreateAsync(Marka marka)
        {
            try
            {
                await _service.AddAsync(marka); //asenkron şekilde yapılan işlem threadi bloke etmeden arka planda yapara
        ...
        public async Task<ActionResult> EditAsync(int id, Marka marka)
        {
            try
            {
                _service.Update(marka); //asenkron şekilde yapılan işlem threadi bloke etmeden arka planda yapara
                await _service.SaveAsync();
                return RedirectToAction(nameof(Index));
            }
            catch
